...
opt -load-pass-plugin ./build/pass/prefetchIMAPass.dylib -passes='prefetch-ima' --ima-function-pattern="compute_page_rank" -S testcases/pagerank_vector_preprocess.ll -o testcases/pagerank_vector_prefetch_out.ll
...
opt -load-pass-plugin ./build/pass/prefetchIMAPass.dylib -passes='prefetch-ima' --ima-function-pattern="compute_page_rank" -S testcases/pagerank_array_preprocess.ll -o testcases/pagerank_array_prefetch_out.ll
